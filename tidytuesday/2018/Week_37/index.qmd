...
#| label = "my Tweet",
#| echo = FALSE
blogdown::shortcode('tweet','1073204074579968000')
```
...
```{r}
#| label = "Administrative Miscellaneous"
# subsetting data 
# Specific insepction type, critical flag and year with bar plot 
...
```{r}
#| label = "Most 5 Inspected Restaurants"
...
```{r}
#| label = "Dunkin Donuts, score and critical flag with cuisine
...
```{r}
#| label = "Subway, score and critical flag with cuisine description over
#| years"
...
```{r}
#| label = "McDonalds scores, score and critical flag with cuisine
#| description over years"
...
```{r}
#| label = "Starbucks, score and critical flag with cuisine description
#| over years"
...
```{r}
#| label = "Kennedy Fried Chicken, score and critical flag with cuisine
#| description over years"
