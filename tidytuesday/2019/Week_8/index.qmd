...
```{r}
#| label = "Broad field boxplot without psy and soc sciences"
...
```{r}
#| label = "mathematics and cs bar chart"
...
```{r}
#| label = "major field boxplot with maths and cs"
...
```{r}
#| label = "field boxplot with maths and cs"
p<-ggplot(subset(phdlist,broad_field == "Mathematics and computer sciences"),
...
```{r}
#| label = "broad and major and field"
