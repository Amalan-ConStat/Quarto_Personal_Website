...
```{r}
#| label = "load th data and packages"
...
#| label = "tweet",
#| echo = FALSE
blogdown::shortcode("tweet","1136303490978988033")
```
...
```{r}
#| label = "Rating stars of 4 or above 4 for Brands"
ramen_ratings %>%
  subset(stars >=4)%>%
...
```{r}
#| label = "Rating stars of 2 or below 2 for Brands"
ramen_ratings %>%
  subset(stars < 2)%>%
  count(brand,sort = TRUE) %>%
  top_n(25) %>%
...
```{r}
#| label = "Rating stars of 4 or above 4 for Style"
ramen_ratings %>%
  subset(stars >=4)%>%
...
```{r}
#| label = "Rating stars of 2 or below 2 for Style"
ramen_ratings %>%
  subset(stars < 2)%>%
  count(style,sort = TRUE) %>%
  top_n(5) %>%
...
```{r}
#| label = "Rating stars of 4 or above 4 for Country"
ramen_ratings %>%
  subset(stars >=4)%>%
...
```{r}
#| label = "Rating stars of below 2 for Country"
ramen_ratings %>%
  subset(stars < 2)%>%
  count(country,sort = TRUE) %>%
  top_n(25) %>%
...
```{r}
#| label = "Rating stars of 4 or above 4 for Brand and Style"
ramen_ratings %>%
  subset(stars >=4)%>%
...
```{r}
#| label = "Rating stars of below 2 for Brand and Style"
ramen_ratings %>%
  subset(stars <2)%>%
  count(brand,style,sort = TRUE) %>%
  top_n(25) %>%
...
```{r}
#| label = "Rating stars of 4 or above 4 for Brand and Country"
ramen_ratings %>%
  subset(stars >=4)%>%
...
```{r}
#| label = "Rating stars of below 2 for Brand and Country"
ramen_ratings %>%
  subset(stars <2)%>%
  count(brand,country,sort = TRUE) %>%
  top_n(25) %>%
...
```{r}
#| label = "Rating stars of 4 or above 4 for Style and Country"
ramen_ratings %>%
  subset(stars >=4)%>%
...
```{r}
#| label = "Rating stars of below 2 for Style and Country"
ramen_ratings %>%
  subset(stars <2)%>%
  count(style,country,sort = TRUE) %>%
  top_n(25) %>%
...
```{r}
#| label = "Rating stars of 4 or above 4 for Brand,Style and Country"
ramen_ratings %>%
  subset(stars >=4)%>%
...
```{r}
#| label = "Rating stars of below 2 for Brand,Style and Country"
ramen_ratings %>%
  subset(stars <2)%>%
  count(brand,style,country,sort = TRUE) %>%
  top_n(25) %>%
