...
```{r,eval=FALSE}
#| label = "Daily members by week of day",
#| fig.width = 14,
#| fig.height = 12
...
```{r,eval=FALSE}
#| label = "Weekly members by week of day",
#| fig.width = 14,
#| fig.height = 12
...
```{r}
#| label = "public private shared channels"
ggbetweenstats(
...
```{r}
#| label = "percent public private shared channels"
ggbetweenstats(
...
```{r}
#| label = "public shared channels, by week of Day"
ggbetweenstats(
               data = r4ds_members %>% mutate(day=wday(date,label = TRUE)) %>%
...
```{r}
#| label = "percent public shared channels, by week of Day"
ggbetweenstats(
               data = r4ds_members %>% mutate(day=wday(date,label = TRUE)) %>%
...
```{r}
#| label = "private shared channels, by week of Day"
ggbetweenstats(
               data = r4ds_members %>% mutate(day=wday(date,label = TRUE)) %>%
...
```{r}
#| label = "percent private shared channels, by week of Day"
ggbetweenstats(
               data = r4ds_members %>% mutate(day=wday(date,label = TRUE)) %>%
...
```{r}
#| label = "DM channels, by week of Day"
ggbetweenstats(
               data = r4ds_members %>% mutate(day=wday(date,label = TRUE)) %>%
...
```{r}
#| label = "percent DM channels, by week of Day"
ggbetweenstats(
               data = r4ds_members %>% mutate(day=wday(date,label = TRUE)) %>%
