...
```{r}
#| label = "lading data and packages"
# load the data
...
#| label = "tweet",
#| echo = FALSE
blogdown::shortcode("tweet","1161214486012993536")
```
...
```{r}
#| label = "Days in Power vs Days Alive"
emperors %>%
  mutate(reign_time=reign_end-reign_start) %>%
