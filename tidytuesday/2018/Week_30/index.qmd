...
```{r}
#| label = "table for rating vs genre"
...
```{r}
#| label = "table for rating vs genre percentage"
...
```{r}
#| label = "domestic gross zero movies",
#| results = "hide"
...
```{r}
#| label = "graphical analysis for domestic gross zero movies",
#| fig.height = 11,
#| fig.width = 11
...
```{r}
#| label = "Domestic zero and genre with rating"
...
```{r}
#| label = "Domestic zero Boxplot production budget with genre"
...
```{r}
#| label = "Domestic zero Boxplot production budget with rating"
#plotting production budget with genre
Movie_domestic_zero %>% 
...
```{r}
#| label = "list of movies production budget"
...
```{r}
#| label = "Confirm possibility of information loss Year"
...
```{r }
#| label = "Confirm possibility of month"
...
```{r}
#| label = "Confirm possibility of day"
