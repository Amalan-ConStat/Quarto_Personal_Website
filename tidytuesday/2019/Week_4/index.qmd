...
```{r,eval=FALSE}
#| label = "prison summary Male and Female"
...
```{r,eval=FALSE}
#| label = "prison summary Ethnicity"
...
```{r,eval=FALSE}
#| label = "prison summary Other and Total"
...
```{r,eval=FALSE}
#| label = "pretrial summary gender and total"
...
```{r}
#| label = "All Data Rape Crime but rural",
#| fig.length = 14,
#| fig.width = 14
...
```{r}
#| label = "All Data Rape Crime but small or mid",
#| fig.length = 14,
#| fig.width = 14
...
```{r}
#| label = "All Data Rape Crime but suburban",
#| fig.length = 14,
#| fig.width = 14
...
```{r}
#| label = "All Data Rape Crime but Urban",
#| fig.length = 14,
#| fig.width = 14
