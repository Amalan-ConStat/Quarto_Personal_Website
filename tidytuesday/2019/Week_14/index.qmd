...
```{r}
#| label = "crossing vs direction with M or E and bikecount"
p<-bike_traffic %>%
      cSplit("date",sep=" ") %>%
      rename("DMY"="date_1") %>%
      rename("HMS"="date_2") %>%
...
```{r}
#| label = "Monthly and Dayly Average Bike Count by M or E"
p<-bike_traffic %>%
      cSplit("date",sep=" ") %>%
      rename("DMY"="date_1") %>%
      rename("HMS"="date_2") %>%
...
```{r}
#| label = "Day and Year Averge Bike Count by M or E"
p<-bike_traffic %>%
      cSplit("date",sep=" ") %>%
      rename("DMY"="date_1") %>%
      rename("HMS"="date_2") %>%
...
```{r}
#| label = "Hourly and Year Average Bike Count by M or E"
p<-bike_traffic %>%
      cSplit("date",sep=" ") %>%
      rename("DMY"="date_1") %>%
      rename("HMS"="date_2") %>%
...
```{r}
#| label = "Monthly and Daily Pedestrian Count by M or E when TRUE"
p<-bike_traffic %>%
      cSplit("date",sep=" ") %>%
      rename("DMY"="date_1") %>%
      rename("HMS"="date_2") %>%
...
```{r}
#| label = "Monthly and Daily Pedestrian Count by M or E when FALSE"
p<-bike_traffic %>%
      cSplit("date",sep=" ") %>%
      rename("DMY"="date_1") %>%
      rename("HMS"="date_2") %>%
...
```{r}
#| label = "Day and Year Pedestrian Count by M or E when TRUE"
p<-bike_traffic %>%
      cSplit("date",sep=" ") %>%
      rename("DMY"="date_1") %>%
      rename("HMS"="date_2") %>%
...
```{r}
#| label = "Day and Year Pedestrian Count by M or E when FALSE"
p<-bike_traffic %>%
      cSplit("date",sep=" ") %>%
      rename("DMY"="date_1") %>%
      rename("HMS"="date_2") %>%
...
```{r}
#| label = "Hourly and Year Pedestrian Count by M or E when TRUE"
p<-bike_traffic %>%
      cSplit("date",sep=" ") %>%
      rename("DMY"="date_1") %>%
      rename("HMS"="date_2") %>%
...
```{r}
#| label = "Hourly and Year Pedestrian Count by M or E when FALSE"
p<-bike_traffic %>%
      cSplit("date",sep=" ") %>%
      rename("DMY"="date_1") %>%
      rename("HMS"="date_2") %>%
...
```{r}
#| label = "Monthly and Yearly Average Bike Count by M or E for
#| Crossings"
p<-bike_traffic %>%
      cSplit("date",sep=" ") %>%
      rename("DMY"="date_1") %>%
...
```{r}
#| label = "Monthly and Yearly Average Bike Count by M or E with days for
#| Crossings"
p<-bike_traffic %>%
      cSplit("date",sep=" ") %>%
      rename("DMY"="date_1") %>%
