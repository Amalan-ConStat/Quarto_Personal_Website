...
```{r}
#| label = "Prepare data for TidyTuesday"
# Load the packges
library(ggplot2)
library(ggthemr)
library(stringr)
...
```{r}
#| label = "Age with do people and do not people",
#| out.width = "75%",
#| out.height = "75%"
...
```{r}
#| label = "Age and Gender for Yes people"
attach(Thanksgiving_Yes)
...
```{r}
#| label = "Age and Gender for No people"
attach(Thanksgiving_No)
...
```{r}
#| label = "Age and Family Income for Yes People"
attach(Thanksgiving_Yes)
...
```{r}
#| label = "Age and Family Income for No People"
attach(Thanksgiving_No) 
...
```{r}
#| label = "Age and US Regions for Yes People"
attach(Thanksgiving_Yes)
...
```{r}
#| label = "Age and US Regions for No People"
attach(Thanksgiving_No)
...
```{r}
#| label = "Gender with do people and do not people",
#| out.width = "75%",
#| out.height = "75%"
attach(Thanksgiving_Yes)
attach(Thanksgiving_No)
...
```{r}
#| label = "Gender and Family Income for Yes People"
attach(Thanksgiving_Yes)
...
```{r}
#| label = "Gender and Family Income for No People"
attach(Thanksgiving_No)
...
```{r}
#| label = "Gender and US Region Yes People"
attach(Thanksgiving_Yes)
...
```{r}
#| label = "Gender and US Region No People"
attach(Thanksgiving_No)
...
```{r}
#| label = "Family Income with do people and do not people",
#| out.width = "100%",
#| out.height = "70%"
attach(Thanksgiving_Yes)
attach(Thanksgiving_No)
...
```{r}
#| label = "Family Income and US Regions Yes people"
attach(Thanksgiving_Yes)
...
```{r}
#| label = "Family Income and US Regions No people"
attach(Thanksgiving_No)
...
```{r}
#| label = "US region with do people and do not people",
#| out.height = "70%",
#| out.width = "100%"
attach(Thanksgiving_Yes)
attach(Thanksgiving_No)
