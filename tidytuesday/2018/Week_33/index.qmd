...
```{r}
#| label = "SDI countries Low and Low middle"
attach(MD_CM_SDI)
...
```{r}
#| label = "SDI countries Middle and High-middle"
...
```{r}
#| label = "Andean, Central and Tropical Latin America"
attach(MD_CM_LA)
...
```{r}
#| label = "North and Southern Latin America"
...
```{r}
#| label = "South Asia and Southeast Asia"
attach(MD_CM_A)
...
```{r}
#| label = "High Income Pacific and Australasia"
...
```{r}
#| label = "North Africa and Middle East"
attach(MD_CM_A)
