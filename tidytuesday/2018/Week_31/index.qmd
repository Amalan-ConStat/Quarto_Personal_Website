...
```{r}
#| label = "Prepartion to TidyTuesday"
# load the packages
library(readr)
library(ggplot2)
library(lubridate)
...
```{r}
#| label = "Sri Lanka data extraction"
...
```{r}
#| label = "R versions with operating system"
...
```{r}
#| label = "Date versus Operating system for Month"
...
```{r}
#| label = "Date versus Operating system for Days"
...
```{r}
#| label = "Date versus Operating system for Hours"
...
```{r}
#| label = "Date versus Operating system for minutes"
