...
```{r}
#| label = "Paris Montparnasse total num of trips"
...
```{r}
#| label = "Paris Montparnasse Journey time average"
p<-ggplot(subset(small_trains,departure_station=="PARIS MONTPARNASSE"),
...
```{r}
#| label = "Paris Montparnasse avg delay all departing"
p<-ggplot(subset(small_trains,departure_station=="PARIS MONTPARNASSE"),
...
```{r}
#| label = "Paris Montparnasse avg delay all arriving"
p<-ggplot(subset(small_trains,departure_station=="PARIS MONTPARNASSE"),
...
```{r}
#| label = "Paris Montparnasse num late at departure"
p<-ggplot(subset(small_trains,departure_station=="PARIS MONTPARNASSE"),
...
```{r}
#| label = "Paris Montparnasse num arriving late"
p<-ggplot(subset(small_trains,departure_station=="PARIS MONTPARNASSE"),
...
```{r}
#| label = "departure station with journey time avg and total num trips"
...
```{r}
#| label = "departure station with Number of late and average Delay"
...
```{r}
#| label = "departure station with Number of Arriving late and average
#| Delay arriving"
...
```{r}
#| label = "Delayed No and Delayed cause"
small_trains %>%
