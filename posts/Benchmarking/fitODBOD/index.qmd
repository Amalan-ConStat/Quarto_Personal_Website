...
```{r}
#| label = "nlm function from stats package",
#| results = "hide"
...
```{r}
#| label = "nlminb function from stats package",
#| results = "hide"
...
```{r}
#| label = "ucminf function from stats package",
#| results = "hide"
library(ucminf)
...
```{r}
#| label = "maxLik function from maxLik package",
#| results = "hide"
library(maxLik)
...
```{r}
#| label = "mle function from stats4 package",
#| results = "hide"
library(stats4)
...
```{r}
#| label = "mle2 function from bbmle package",
#| results = "hide"
library(bbmle)
...
```{r}
#| label = "Summary of package info,input and output",
#| echo = FALSE
Results1<-data.frame(
