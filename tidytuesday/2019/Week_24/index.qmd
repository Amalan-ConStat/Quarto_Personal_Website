...
```{r}
#| label = "tweet by others",
#| echo = FALSE
blogdown::shortcode("tweet","1138187182559170560")
```

Frames change is based on year, and meteors which have missing values are dropped.

```{r}
#| label = "meteorites over the year"
...
```{r}
#| label = "meteorites and classes jitter plot"
test %>%
...
#| label = "my tweet",
#| echo = FALSE
blogdown::shortcode("tweet","1138476351453913090")
```
