...
```{r}
#| label = "tweet i posted",
#| echo = FALSE
blogdown::shortcode("tweet","1090266660785729536")
```
...
```{r}
#| label = "State Milk production Us Map",
#| fig.height = 14,
#| fig.width = 14
...
```{r}
#| label = "State Milk production Us Map 1",
#| fig.height = 14,
#| fig.width = 14
...
```{r}
#| label = "State Milk production over the years for states"
...
```{r}
#| label = "State milk production altering by summation or mean"
...
```{r}
#| label = "State milk production by region for summation"
...
```{r}
#| label = "Summation by region for jitter"
...
```{r}
#| label = "Summation by region for jitter by year animation"
...
```{r}
#| label = "State milk production by region for average"
...
```{r}
#| label = "average by region for jitter"
...
```{r}
#| label = "average by region for jitter by year animation"
