...
```{r}
#| label = "Step 1 load the packages and file"
# load the packages 
library(pdftools)
library(stringr)
...
```{r}
#| label = "Extracting two tables from all pages which has two tables"
...
```{r}
#| label = "extracting pages with two tables",
#| warning = FALSE
...
```{r}
#| label = "one table page extraction"
