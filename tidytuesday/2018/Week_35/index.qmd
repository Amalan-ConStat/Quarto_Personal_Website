...
```{r}
#| label = "Preparing for TidyTuesday"
...
```{r}
#| label = "County with Condition and Average Daily Traffic SHA"
...
```{r}
#| label = "County with Condition and Average Daily Traffic CHA"
...
```{r}
#| label = "County with Condition and Average Daily Traffic STA"
...
```{r}
#| label = "Year Built with Condition and Average Daily Traffic"
...
```{r}
#| label = "Average Traffic less than 100000"
...
```{r}
#| label = "Average Traffic more than 100000"
...
```{r}
#| label = "Bridge Condition and County with Improvement Next 7"
...
```{r}
#| label = "Bridge Condition and County with Improvement Top 3"
# removing unnecessary columns and setting restriction to 
# Total Improvement
