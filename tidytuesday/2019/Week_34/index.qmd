...
#| label = "setup",
#| include = FALSE
knitr::opts_chunk$set(echo = TRUE,fig.width = 10,fig.height = 8,message = FALSE,warning = FALSE)
```

[GitHub Code](https://github.com/Amalan-ConStat/TidyTuesday/tree/master/2019/Week34)

```{r}
#| label = "tweet",
#| echo = FALSE
blogdown::shortcode("tweet","1163767794636328960")
```
