...
```{r}
#| label = "Loading packages and preparing data"
...
#| label = "My Tweet",
#| echo = FALSE
blogdown::shortcode('tweet','1082693109304168448')
```

TV shows from 1990 to 2018 with their ratings, genres, sharing and aired dates is in this data-set.
I wanted a cool function to summarize the data-set at once, therefore browse through the internet
...
```{r,echo=FALSE}
#| label = "Basic summary of the Ratings Dataset"
...
Which means most of the TV shows have only up-to few seasons. I would guess not more than 5.
...
Some TV shows might have to start on the same day, that is the only plausible conclusion.
...
Most of the TV shows in this genre type are limited to one season an a few more with 2 or 3 seasons.
...
Clearly we can see the number of shows increasing from 1990 to 2018. Oddly there was more
sharing related to TV shows before 2000, but this is not the case after the birth of Millenium. To be honest
sharing becomes more extinct even with the power of Internet and smart phones. 
