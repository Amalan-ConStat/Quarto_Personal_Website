...
```{r,eval=FALSE}
#| label = "Other with No Sub-Groups"
DiagrammeR("graph TB;
...
```{r,eval=FALSE}
#| label = "Alternate Binomial Distributions"
DiagrammeR("graph TB;
...
```{r,eval=FALSE}
#| label = "Neyman Type A Distribution"
DiagrammeR("graph TB;
...
```{r,eval=FALSE}
#| label = "Log Inverse Distribution 0,1 Domain"
DiagrammeR("graph LR;
           A[Binomial <br> Distribution]-->B[Binomial <br> Parent];
           B-->C[Mixing Parameter];
